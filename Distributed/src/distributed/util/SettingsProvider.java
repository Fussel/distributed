...
>>>>>>> origin/leaderchannel_dirverse_bugs
    ...
    public void storeUserInterface(String userInterface) {
        props.setProperty(USER_INTERFACE, userInterface);
        writePropertyChanges();
    }

    /**
     * The type of the user. At the moment just moderator or user are allowed;
     *
     * @param userType
     */
    ...
    public String getUserInterface() {
        return props.getProperty(USER_INTERFACE, null);
    }
